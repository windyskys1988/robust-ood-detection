...
import models.densenet_cpu as dn
...
parser.add_argument('--num',default=5, type=int,
                    help='The number of dataset categories you need (default: 10)')
parser.add_argument('--div',default=2, type=int,
                    help='The number of divided dataset you need (default: 2)')
parser.add_argument('--tag',default='0,1,2,3,4', type=str,
...
def main():
    ...
    if args.in_dataset == "CIFAR-10":
        train_loader = torch.utils.data.DataLoader(
            expand_cifar10_dataset.taggedCIFAR10('../../data', train=True, download=True, tag=tags,
                                                 transform=transform_train),
            batch_size=args.batch_size, shuffle=True, **kwargs)
        val_loader = torch.utils.data.DataLoader(
            expand_cifar10_dataset.taggedCIFAR10('../../data', train=False, download=True, tag=tags,
                                                 transform=transform_test),
            batch_size=args.batch_size, shuffle=True, **kwargs)
    elif args.in_dataset == "CIFAR-100":
        train_loader = torch.utils.data.DataLoader(
            expand_cifar100_dataset.taggedCIFAR100('../../data', train=True, download=True, tag=tags,
                                                   transform=transform_train),
            batch_size=args.batch_size, shuffle=True, **kwargs)
        val_loader = torch.utils.data.DataLoader(
            expand_cifar100_dataset.taggedCIFAR100('../../data', train=True, download=True, tag=tags,
