...
def convert_train_data(file_dir):
    root_dir = './datasets/gtsrb/data/train'
...
def convert_test_data(file_dir):
    root_dir = './datasets/gtsrb/data/test'
...
if __name__ == "__main__":
    # train_data_dir =os.path.join(os.getcwd(), 'datasets/gtsrb/Training/')
    test_data_dir = os.path.join(os.getcwd(), 'datasets/gtsrb/Final_Test/Images')
